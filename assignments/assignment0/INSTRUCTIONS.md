...
3. **Create a branch off `main` in the GitHub UI**
   ...
   - Type a branch name such as `assignment0-yourname`.
...
4. **Open a Codespace**
   ...
   - Click **Create codespace on assignment0-yourname**.
...
5. **Edit your student file**
   - In Codespaces, open `assignments/assignment0/student_work.py`.
   - Replace `STUDENT_NAME = "Your Name"` with your real name.
   - Save the file.

6. **Run tests from the Testing panel**
   - Click the **Testing** beaker icon in the left sidebar.
   - Find `assignments/assignment0/test_assignment.py`.
...
7. **Commit with Source Control UI**
   ...
   - Enter a commit message like `Complete assignment0`.
   - Click **Commit**.
